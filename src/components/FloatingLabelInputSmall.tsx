...
export function FloatingLabelInputSmall({
    label,
    ...props
        ...
        <div className="relative w-full">
            <input
                ...
                className={cn(
                    ...
                    "font-montserrat px-2 pt-2 pb-1 text-[20px] font-bold leading-none",
                )}
                placeholder=" " // Ensures placeholder-shown works properly
            />
            <label
                className={cn(
                    "font-montserrat absolute top-2 left-1 text-[20px] font-bold transition-all select-none",
